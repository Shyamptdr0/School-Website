      ...
      <div className="flex items-center justify-between px-6 py-3">
        ...
        <div className="flex items-center space-x-6">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-sm text-sky-800">krishna.dhargao@gmail.com</span>
          </div>
          <div className="flex items-center">
            <FontAwesomeIcon icon={faPhone} className="w-4 h-4 text-sky-800" />
            <span className="ml-2 text-sm text-sky-800">+91 8120709899</span>
          </div>
        ...
        {/* right */}
        <div className="flex items-center space-x-6">
          <Link href="/about/disclosure"> <Button className="bg-sky-800 rounded-full cursor-pointer text-white">Mandatory Disclosure</Button> </Link>
          <Link href="/admission/fees"><Button className="bg-sky-800 rounded-full cursor-pointer text-white">Fees</Button></Link>
